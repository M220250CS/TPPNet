...
def multi_train(**kwargs):
    ...
    for (data0, label0), (data1, label1), (data2, label2) in tqdm(zip(train_dataloader0, train_dataloader1, train_dataloader2)):
        # Debug: Print shapes of data and labels
        print(f"data0 shape: {data0.shape}, label0 shape: {label0.shape}")
        print(f"data1 shape: {data1.shape}, label1 shape: {label1.shape}")
        print(f"data2 shape: {data2.shape}, label2 shape: {label2.shape}")
